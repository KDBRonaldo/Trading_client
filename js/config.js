...
const API_CONFIG = {
  ...
  endpoints: {
    login: "/api/v1/external/fund/login",
    fundAccount: "/api/v1/external/fund/snapshot",
    holdings: "/api/v1/external/security/snapshot",
    changePassword: "/api/v1/external/fund/password",
